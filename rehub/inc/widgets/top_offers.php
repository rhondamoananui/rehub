...
function widget( $args, $instance ) {
	...
	?>
	    ...
	    <?php elseif ($post_type == 'thirsty'):?>
	    	<?php rehub_top_offers_widget_block_thirsty($tags, $number, $order);?> 
	...
	function form( $instance ) {
		...
		<p><em><?php _e('If you select Widget base on posts or woocommerce, enter tag slug in field below. If you select ThirstyAffiliate base, widget will show top links of ThirstyAffiliates posts and you can set slug of thirstyaffiliates category. Also, you can set name of meta key for ordering', 'rehub_framework');?></em></p>
