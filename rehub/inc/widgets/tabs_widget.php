...
class rehub_tabs_widget extends WP_Widget {
	...
	function form( $instance ) {
		...
		$defaults = array( 'tabs1' => 'popular', 'tabs2' => 'comments', 'sortby' => 'all_time', 'sortbysec' => 'all_time', 'basedby' => 'comments', 'basedbysec' => 'views', 'titlefirst' => __('Popular', 'rehub_framework'),  'titlesecond' => __('Comments', 'rehub_framework'));
