<style type="text/css">
	...
	<?php endif; ?>				
	<?php if ((vp_metabox('rehub_framework_brand.rehub_background_image_single') || vp_metabox('rehub_framework_brand.rehub_color_background_single')) && (is_single() || is_page())) :?>
	...
	<?php elseif (rehub_option('rehub_branded_bg_url') ) :?>
		...
		#branded_bg {height: 100%;left: 0;position: fixed;top: 0;width: 100%;
z-index: 0;}
		footer, .top_theme, .content, .footer-bottom { position: relative; z-index: 1 }
  		/*header { position: relative; z-index: 99 }*/
	<?php endif; ?>
