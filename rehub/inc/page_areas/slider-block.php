		            ...
		            <div class="flex-overlay">
		              ...
		              <h2><a href="<?php the_permalink();?>"><?php the_title();?></a></h2>
	            		<?php if (rehub_option('rehub_readmore_text') !=''): ?>
				  			<a href="<?php the_permalink();?>" class="read-more"><?php echo strip_tags(rehub_option('rehub_readmore_text'));?></a> 		  					  		 		  		
				  		<?php else: ?>
							<a href="<?php the_permalink();?>" class="read-more"><?php _e('Read more', 'rehub_framework') ;?></a>
				  		<?php endif ?>		              
		              <?php if (rehub_option('exclude_comments_meta') == 0) : ?><?php comments_popup_link( 0, 1, '%', 'comment', ''); ?><?php endif ;?> </div>
		          </li>
		        <?php endwhile; endif; wp_reset_query(); ?>    		
        	<?php endif ;?> 
    	</ul>
