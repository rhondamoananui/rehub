...
/*
 ...
 Icon: http://www.google.com/s2/favicons?domain=amazon.it
 CPA: 
 */
 ...
 */
class AmazonitParser extends ShopParser {
    ...
    public function parseExtra() {
        ...
        for ($i = 0; $i < count($names); $i++) {
            if (!empty($values[$i]) && $names[$i] != 'Stato:' && $names[$i] != 'Marca:') {
        ...
        for ($i = 0; $i < count($names2); $i++) {
            if (!empty($values2[$i]) && $name2[$i] != 'Stato:' && $names2[$i] != 'Marca:') {
