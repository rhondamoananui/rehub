...
<?php endif; ?>
  ...
  <div class="logo-section <?php echo rehub_option('rehub_header_style') ;?>_style clearfix">
    ...
    <?php if(rehub_option('rehub_header_style') == 'header_first') : ?>
    ...
    <?php endif; ?>
    <?php if(rehub_option('rehub_header_style') != 'header_third' && rehub_option('rehub_header_style') != 'header_first') : ?><?php if(rehub_option('rehub_ads_top')) : ?><div class="mediad"><?php echo do_shortcode(rehub_option('rehub_ads_top')); ?></div><?php endif; ?><?php endif; ?>
  </div>
  <!-- /Logo section -->  
  <!-- Main Navigation -->
  <div class="main-nav">
