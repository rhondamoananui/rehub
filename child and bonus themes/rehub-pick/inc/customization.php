<style type="text/css">		 
	<?php if (rehub_option('rehub_color_background') && rehub_option('rehub_background_image') =='') :?>
		body{background: none <?php echo rehub_option('rehub_color_background') ?>;}
	<?php endif; ?>	
	<?php if (rehub_option('rehub_background_image') && rehub_option('rehub_color_background')) :?>
		body{background-color: <?php echo rehub_option('rehub_color_background') ?> ; background-image: <?php echo rehub_option('rehub_background_image') ?>; background-repeat: repeat; background-position: 0 0;}
	<?php endif; ?>				
	...
	<?php endif; ?>	
    <?php if(rehub_option('rehub_sec_color') !='') : ?>
		.widget.widget_affegg_widget .title, .rehub_feat_block.rehub_chimp, .widget.top_offers .title, header .header_first_style .search form input[type="submit"], .widget.tabs .current, .more_post a, .more_post span, .filter_home_pick span.active, .filter_home_pick span:hover { background: <?php echo rehub_option('rehub_sec_color') ?>}
		.widget.widget_affegg_widget .title:after, .widget.top_offers .title:after{border-top-color: <?php echo rehub_option('rehub_sec_color') ?>;}  
		.filter_home_pick span.active, .filter_home_pick span:hover{border: 1px solid <?php echo rehub_option('rehub_sec_color') ?>;}  
	<?php endif; ?>	
<?php 
...
.wpsm-button.orange, .wpsm-button.rehub_main_btn { color: #fff; background-color: <?php echo $colorschema; ?> !important; background-image: none !important; border-radius: 3px !important; box-shadow: none !important; text-transform: uppercase; }
.wpsm-button.orange:hover, .wpsm-button.rehub_main_btn:hover { background: <?php echo $colorschema; ?> !important; background-position: left bottom !important }
.wpsm-button.orange:active, .wps-button.rehub_main_btn:active { background-color: <?php echo $colorschema; ?> !important; top: 2px; box-shadow: none !important }
.wpsm_promobox.rehub_promobox { border-left-color: <?php echo $colorschema; ?>!important; }
