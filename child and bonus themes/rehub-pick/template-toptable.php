...
<?php 
    ...
    $first_column_name = (vp_metabox('rehub_top_table.first_column_name') !='') ? esc_html(vp_metabox('rehub_top_table.first_column_name')) : __('Product', 'rehub_child') ;
    ...
    <div class="content">   
		<div class="clearfix">
            ...
            <div class="main-side no_bg_wrap page clearfix<?php if ($module_width =='1') : ?> full_width<?php endif;?>">
                ...
                <?php else: ?><?php _e('No posts for this criteria.', 'rehub_child'); ?>
                <?php endif; ?>
