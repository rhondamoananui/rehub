...
/*
 ...
 Icon: http://www.google.com/s2/favicons?domain=amazon.de
 CPA: 
 */
 ...
 */
class AmazondeParser extends ShopParser {
    ...
    public function parseExtra() {
        ...
        for ($i = 0; $i < count($names); $i++) {
            if (!empty($values[$i]) && $names[$i] != 'Condition:' && $names[$i] != 'Marke:') {
        ...
        for ($i = 0; $i < count($names2); $i++) {
            if (!empty($values2[$i]) && $name2[$i] != 'Bedingung:' && $names2[$i] != 'Marke:') {
