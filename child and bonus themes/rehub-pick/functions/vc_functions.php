...
vc_map( array(
    ...
    "base" => "grid_loop_mod",
    "icon" => "icon-g-l-loop",
    "category" => __('RE Pick block', 'rehub_child'), 
    "params" => array(
        array(
            "type" => "dropdown",
            "class" => "",
...
vc_map( array(
    ...
    "params" => array(  
        ...
        array(
            "type" => "textfield",
            "heading" => __('Description', 'rehub_child'),
            "param_name" => "description",
            "value" => '',           
        ), 
        array(
            'type' => 'attach_image',
            'heading' => __('Image', 'rehub_child'),
            'param_name' => 'image',
            'value' => '',
        ),
        array(
            "type" => "checkbox",
            "class" => "",
            "heading" => __('Make background image contain?', 'rehub_child'),
            "value" => array(__("Yes", "rehub_child") => true ),
            "param_name" => "bg_contain",         
        ),        
        array(
            "type" => "textfield",
            "heading" => __('URL:', 'rehub_child'),
            "param_name" => "link",
            'description' => __('Will be used on image and title', 'rehub_child'),
        ),                                              
