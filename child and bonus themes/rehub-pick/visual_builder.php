...
<?php endif ;?>
    ...
    <div class="content <?php echo $content_type ?>">     
		<div class="clearfix">
		    <!-- Main Side -->
            <div class="main-side visual_page_builder page_builder clearfix full_width<?php if($content_type =='no_shadow') : ?> no_bg_wrap<?php endif ;?>">
...
<?php if(rehub_option('rehub_disable_totop') !='1')  : ?><a href="#top_ankor" class="rehub_scroll" id="topcontrol"><i class="fa fa-chevron-up"></i></a><?php endif; ?>
<?php wp_footer(); ?>
</body>
</html>
<?php else :?>
