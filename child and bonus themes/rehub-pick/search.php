...
<div class="content"> 
    <div class="clearfix">
          <!-- Main Side -->
          <div class="main-side no_bg_wrap clearfix<?php if (rehub_option('rehub_framework_search_layout') == 'rehub_framework_archive_gridfull') : ?> full_width<?php endif ;?>">
            ...
            <?php while (have_posts()) : the_post(); ?>
                <?php if (rehub_option('rehub_framework_search_layout') == 'rehub_framework_archive_list') : ?>
