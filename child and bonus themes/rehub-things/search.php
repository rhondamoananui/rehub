        ...
        <div class="main-side clearfix<?php if (rehub_option('rehub_framework_category_layout') == 'three_column_full' || rehub_option('rehub_framework_category_layout') == 'two_column_full' || rehub_option('rehub_framework_category_layout') == 'blog_full') : ?> full_width<?php else : ?> w_sidebar<?php endif ;?>">
            ...
            <?php endif ;?>
                ...
                <?php while (have_posts()) : the_post(); $i ++ ; ?>
                    ...
                    <?php elseif (rehub_option('rehub_framework_category_layout') == 'two_column_full') : ?>
                        <?php rehub_create_column('big') ;?> 
                    <?php elseif (rehub_option('rehub_framework_category_layout') == 'two_column_with' || rehub_option('rehub_framework_category_layout') == 'three_column_full') : ?>
                ...
                <?php else : ?>		
                    <h5><?php _e('Sorry. No posts founded', 'rehub_child'); ?></h5>				   
                <?php endif; ?>
                </div>
