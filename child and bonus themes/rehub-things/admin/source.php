...
function top_list_shortcode()
{
		...
		$result = ''.__("You can use shortcode to insert this top list to another page", "rehub_child").' <strong>[wpsm_top id="'.get_the_ID().'" full_width="1"]</strong><br />'.__("Delete full_width attribute if you insert shortcode in page with sidebar", "rehub_child").'';
...
function top_table_shortcode()
{
		...
		$result = ''.__("You can use shortcode to insert this top table to another page", "rehub_child").' <strong>[wpsm_toptable id="'.get_the_ID().'" full_width="1"]</strong><br />'.__("Delete full_width attribute if you insert shortcode in page with sidebar", "rehub_child").'';
...
function top_charts_shortcode()
{
		...
		$result = ''.__("You can use shortcode to insert this top charts to another page", "rehub_child").' <strong>[wpsm_charts id="'.get_the_ID().'"]</strong>';
