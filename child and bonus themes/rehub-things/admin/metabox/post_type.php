				...
				array(
					...
					'fields'    => array(
						...
						array(
							...
							'label' => __('Note', 'rehub_framework'),
							'description' => __('You can connect thirstyaffiliate offer to product review with selecting it in field below. You can also add direct offer to post in <strong>Post offer</strong> meta section', 'rehub_framework'),
							'status' => 'normal',
						),						
						...
						array(
							...
							'description' => __('Choose affiliate link that you want to show as product offer or set data in Post offer section', 'rehub_child'),
							'items' => array(
								'data' => array(
									array(
										'source' => 'function',
						...
						array(
							'type' => 'notebox',
							'name' => 'review_aff_note_sec',
							'label' => __('Note', 'rehub_framework'),
							'description' => __('Fields below will be deprecated from 4.5 version. Please, use <strong>Post offer</strong> section for adding offer to post', 'rehub_framework'),
							'status' => 'normal',
						),																		
