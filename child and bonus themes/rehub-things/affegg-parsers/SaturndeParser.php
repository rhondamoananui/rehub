...
class SaturndeParser extends ShopParser {
    ...
    public function parseImg() {
        $imageurl = $this->xpathScalar(".//aside[@id='product-sidebar']/div[@class='preview']//img[@itemprop='image']/@src");
            $imageurl = $imageurl.'.jpg';
        return $imageurl;
    }

    public function parseImgLarge() {
        $imageurlbig = $this->xpathScalar(".//aside[@id='product-sidebar']/div[@class='preview']/a[@class='zoom']/@href");
